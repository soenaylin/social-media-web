...
export default function Profile() {
  ...
  const changeCover = async (e) => {
    ...
    const fileName =
      file.type === "image/png" ? `${id}-cover.png` : `${id}-cover.jpg`;
  ...
  const changePhoto = async (e) => {
    ...
    const fileName =
      file.type === "image/png" ? `${id}-photo.png` : `${id}-photo.jpg`;
        ...
        <Box>
          ...
          <Box sx={{ mb: 4, textAlign: "center" }}>
            ...
            <Typography sx={{ mb: 1, mt: 2 }}>
              {user.name}
              <Typography component="span" sx={{ color: "text.fade", ml: 1 }}>
                . {user.username}
              </Typography>
            </Typography>
            <Typography>
              <Link
                ...
                style={{ textDecoration: "none", color: pink[500] }}
              >
